---
title: Safe-OSE Workshop
layout: default
---

<!--
  ============================================================
  WORKSHOP ORGANIZERS: HOW TO EDIT THIS PAGE
  ============================================================
  This page belongs to the Safe-OSE workshop organizers.

  To update it:
    1. Open this file on GitHub:
       https://github.com/SSDBM/2026/blob/main/workshop-safe-ose.md
    2. Click the pencil icon ("Edit this file") in the top right.
    3. Edit the Markdown below. Anything marked TODO is a
       placeholder waiting for your content.
    4. Scroll down, click "Propose changes", then
       "Create pull request".
    5. The web chair will review and merge it, and the page
       updates automatically a few minutes later.

  Please keep the front matter (the three lines between the
  "---" markers at the very top) unchanged, and limit edits
  to this file only.
  ============================================================
-->
...
**Wednesday, August 12, 2026 (afternoon)**<br>
San Diego Supercomputer Center, UC San Diego<br>
Room: TBD
...
<!-- TODO: Fill in the workshop agenda. Example format:

| Time | Session |
|------|---------|
| 1:00 PM - 1:15 PM | Welcome and Introduction |
| 1:15 PM - 2:30 PM | Session 1: TBD |
| 2:30 PM - 3:00 PM | Coffee Break |
| 3:00 PM - 4:30 PM | Session 2: TBD |
